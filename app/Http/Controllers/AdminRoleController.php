...
class AdminRoleController extends Controller
{
    ...
    function add()
    {
        ...
        // dd($list_role);
        return view('layouts.admin.role.add', compact('list_role'));
    }
    ...
    function list()
    {
        ...
        return view('layouts.admin.role.list', compact('roles'));
    }
    ...
    function edit($id)
    {
        ...
        // dd($list_role);
        // dd($roles);
        return view('layouts.admin.role.edit', compact('role', 'roles', 'list_role'));
    }
