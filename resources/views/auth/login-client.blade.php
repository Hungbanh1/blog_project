    ...
    @if (session('success'))
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                setTimeout(function() {
                    window.location.href = '{{ route('dashboard_client') }}';
        ...
        <div class="row">
            <div class="col-12 py-2 pl-4 header">
                <div class="header-login py-1 container d-flex" style="justify-content:space-between">
                    ...
                    <a class="mt-3" href="{{ route('admin') }}">Đăng nhập Admin</a>
        ...
        <div class="login-form mt-5">
            <form method="POST" action="{{ route('login-client') }}">
                ...
                <div class="form-group text-center py-3 mb-0 border-h-login mb-5">
                    <label class="" for="">Đăng nhập Client</label>
                </div>
            ...
            <div class="text-center my-4 pb-4 "><span class="mr-1">Bạn chưa có tài khoản?</span><a
                    href="{{ route('ui_register_client') }}">Đăng
                    ký ngay</a></div>
        </div>
    </div>
