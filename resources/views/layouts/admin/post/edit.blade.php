            ...
            <div class="card-body">
                <form action="{{ route('update_post', $posts->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" value="{{ $posts->title_head }}" type="text" name="title_head"
                            id="title_head">
                        @error('title_head')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="thumb_head" value="{{ $posts->thumb_head }}" id="thumb_head">
                        @error('thumb_head')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" value="{{ $posts->desc }}" name="desc"
                            id="desc">
                        @error('desc')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
