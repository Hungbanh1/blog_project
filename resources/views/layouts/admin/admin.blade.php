            ...
            <div class="nav-right ">
                <div class="btn-group mr-auto">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ url('admin/author/add') }}">Thêm tác giả</a>
                        <a class="dropdown-item" href="{{ url('admin/post/add') }}">Thêm bài viết</a>
                        <a class="dropdown-item" href="{{ url('admin/user/add') }} ">Thêm User</a>
                        <a class="dropdown-item" href="{{ url('admin/role/add') }} ">Thêm Role</a>
                    </div>
                </div>
                <div class="btn-group">
        ...
        <div id="page-body" class="d-flex">
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link {{ $module_active == 'author' ? 'active' : '' }}">

                        <a href="{{ url('admin/author/list') }}">
                            <div class="nav-link-icon d-inline-flex">
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{ route('author_add') }}">Thêm mới</a></li>
                            <li><a href="{{ route('author_list') }}">Danh sách</a></li>
                        </ul>
                    </li>
                    <li class="nav-link {{ $module_active == 'post' ? 'active' : '' }}">
                        ...
                        <i class="arrow fas fa-angle-right"></i>
                        <ul class="sub-menu">
                            <li><a href="{{ route('post_add') }}">Thêm mới</a></li>
                            <li><a href="{{ route('post_list') }}">Danh sách</a></li>
                            <li class="disable-links"><a href="{{ url('admin/post/list/cat') }}">Danh mục</a></li>
                        </ul>
                    </li>
